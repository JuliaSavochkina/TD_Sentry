...
def extract_info(type_of_search: str, response_json: Generator) -> set:
    """
    Получает на вход гененратор с информацией одной страницы выдачи API. Достает для каждого event type_of_search и дату дейсвтия, если таковая имеется. Складывает в множество, чем гарантируется уникальность event'ов.
